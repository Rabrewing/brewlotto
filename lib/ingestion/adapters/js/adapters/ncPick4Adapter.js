...
/**
 * NC Pick 4 Adapter
 * Ingests North Carolina Pick 4 historical data from CSV files
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.NCPick4Adapter = void 0;
exports.ingestNCPick4Data = ingestNCPick4Data;
const fs = require("fs/promises");
const path = require("path");
const supabase_js_1 = require('@supabase/supabase-js");
const parser_js_1 = require(__dirname + '/../core/parser.js");
const normalizer_js_1 = require(__dirname + '/../core/normalizer.js");
const validator_js_1 = require(__dirname + '/../core/validator.js");
const sourceRegistry_js_1 = require(__dirname + '/../core/sourceRegistry.js");
class NCPick4Adapter {
    ...
    async ingest() {
        ...
        try {
            ...
            const sourceConfig = (0, sourceRegistry_js_1.getSourceConfig)('nc_pick4_official');
            if (!sourceConfig) {
                result.errors.push(`Source configuration not found: nc_pick4_official`);
                return result;
            }
            // Check if file exists
            const filePath = path.join(this.dataDir, 'nc', 'nc-pick4.csv');
            try {
            ...
            for (const row of parsedRows) {
                ...
                const remappedRow = this.remapColumns(row, 'pick4');
                const normalized = (0, normalizer_js_1.normalizeDraw)(remappedRow, 'NC_PICK4', // Game config key for NC Pick 4
    ...
    remapColumns(row, game) {
        const remapped = { ...row };
        // Handle NC CSV format: "MM/DD/YYYY", "Draw Type", "Num1-Num2-Num3-Num4"
        ...
        if (remapped['Winning Numbers'] && !remapped.n1) {
            ...
            const numbers = numbersStr
                ...
                .filter(n => !isNaN(n));
            // Store as individual n1, n2, n3, n4 fields for normalizer
            if (numbers.length >= 1)
    ...
    assignDrawWindows(draws, game, gameId, sourceId) {
        ...
        draws.forEach(draw => {
            ...
            // Set time based on draw type (NC Pick 4: Day ~1:00 PM ET, Evening ~8:30 PM ET)
    ...
    getGameConfig(game) {
        ...
        return configs[game] || configs.pick4;
    }
}
exports.NCPick4Adapter = NCPick4Adapter;
/**
 * Main execution function
 */
async function ingestNCPick4Data() {
    console.log('🚀 Starting NC Pick 4 data ingestion...');
