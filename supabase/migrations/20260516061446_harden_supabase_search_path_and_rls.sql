-- BrewLotto V1: harden function search_path settings and narrow legacy write policies.
...
DROP POLICY IF EXISTS "Allow insert via service role" ON public.mega_draws;
CREATE POLICY "Allow insert via service role" ON public.mega_draws
FOR INSERT TO service_role
WITH CHECK (true);

DROP POLICY IF EXISTS "Allow insert via service role" ON public.pick3_draws;
CREATE POLICY "Allow insert via service role" ON public.pick3_draws
FOR INSERT TO service_role
WITH CHECK (true);

DROP POLICY IF EXISTS "Allow insert via service role" ON public.pick4_draws;
CREATE POLICY "Allow insert via service role" ON public.pick4_draws
FOR INSERT TO service_role
WITH CHECK (true);

DROP POLICY IF EXISTS "Allow insert via service role" ON public.pick5_draws;
CREATE POLICY "Allow insert via service role" ON public.pick5_draws
FOR INSERT TO service_role
WITH CHECK (true);

DROP POLICY IF EXISTS "Allow insert via service role" ON public.powerball_draws;
CREATE POLICY "Allow insert via service role" ON public.powerball_draws
FOR INSERT TO service_role
WITH CHECK (true);

DROP POLICY IF EXISTS "Allow authenticated users to delete from pick_history" ON public.pick_history;
CREATE POLICY "Allow service role to delete from pick_history" ON public.pick_history
FOR DELETE TO service_role
USING (true);

DROP POLICY IF EXISTS "Allow authenticated users to insert into pick_history" ON public.pick_history;
CREATE POLICY "Allow service role to insert into pick_history" ON public.pick_history
FOR INSERT TO service_role
WITH CHECK (true);

DROP POLICY IF EXISTS "Allow authenticated users to update pick_history" ON public.pick_history;
CREATE POLICY "Allow service role to update pick_history" ON public.pick_history
