// @module: pages/pick4.js
// @updated: 2025-06-26
// @description: Pick 4 Smart Picks — Supabase live draw + strategy selector
...
export default function Pick4() {
    ...
    useEffect(() => {
        ...
        getLatestDrawResults("pick4")
            .then((data) => {
                console.log("Latest Pick 4 Draws:", data);
    ...
    return (
        <RequireAuth>
            <div className="flex flex-col min-h-screen items-center bg-[#181818] text-white p-6">
                ...
                <GameStrategySelector gameType="pick4" onRun={handleSmartPick} />
                ...
                <div className="w-full max-w-md mb-6 mt-6">
                        ...
                        {latestLoading ? (
                            ...
                            <div className="w-full max-w-md mx-auto flex flex-col gap-4 mt-6">
                                {["day", "evening"].map((type) => (
                                    <div
                                        key={type}
                                        className="bg-[#232323] rounded-xl p-4 shadow border-l-4 border-[#FFD700] transition-all"
                                    >
                                        <div className="text-sm text-gray-400 uppercase tracking-wide">
                                            {type === "day" ? "Day Draw" : "Evening Draw"}
                                        </div>
                                        <div className="text-2xl font-bold text-[#FFD700] tracking-wider">
                                            {latest?.[type]?.result || "— — — —"}
                                        </div>
                    ...
                    <div className="mb-6 text-center mt-8">
                        <div className="text-[#FFD700] font-semibold text-base">NC Pick 4 Draw Times</div>
                    ...
                    <div className="bg-[#232323] rounded-2xl p-6 min-w-[280px] flex flex-col items-center shadow-xl">
                        ...
                        {!loading && !pick && (
                            <div className="text-gray-400">
                                Click a strategy to get your pick!
                            </div>
                        )}
                    </div>
